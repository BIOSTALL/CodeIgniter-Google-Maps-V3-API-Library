...
class Googlemaps {
  ...
  var $defaultCenter   = FALSE;  // Used to set a default center when center is set to auto to stop grey box appearing if a user denies geolocation
  ...
  function create_map()
  {
    ...
    if ($this->center=="auto") { // if wanting to center on the users location
      ...
      if ($this->defaultCenter !== FALSE) {
        $this->output_js_contents .= $this->map_name.'.setCenter(new google.maps.LatLng(' . $this->defaultCenter . '));';
      }
